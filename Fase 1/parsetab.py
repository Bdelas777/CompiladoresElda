...
_lr_productions = [
  ...
  ('programa -> TOKEN_PROGRAM TOKEN_ID TOKEN_SEMICOLON saveGo dec_var dec_funcs TOKEN_MAIN fillMain body TOKEN_END','programa',10,'p_programa','yacc.py',44),
  ('saveGo -> empty','saveGo',1,'p_saveGo','yacc.py',53),
  ('fillMain -> empty','fillMain',1,'p_fillMain','yacc.py',61),
  ('dec_var -> vars','dec_var',1,'p_dec_var','yacc.py',70),
  ('dec_var -> empty','dec_var',1,'p_dec_var','yacc.py',71),
  ('dec_funcs -> funcs dec_funcs','dec_funcs',2,'p_dec_funcs','yacc.py',76),
  ('dec_funcs -> empty','dec_funcs',1,'p_dec_funcs','yacc.py',77),
  ('vars -> TOKEN_VAR variable rep_var','vars',3,'p_vars','yacc.py',88),
  ('rep_var -> variable rep_var','rep_var',2,'p_rep_var','yacc.py',98),
  ('rep_var -> empty','rep_var',1,'p_rep_var','yacc.py',99),
  ('variable -> TOKEN_ID mas_ids TOKEN_COLON type TOKEN_SEMICOLON','variable',5,'p_variable','yacc.py',109),
  ('mas_ids -> TOKEN_COMMA TOKEN_ID mas_ids','mas_ids',3,'p_mas_ids','yacc.py',121),
  ('mas_ids -> empty','mas_ids',1,'p_mas_ids','yacc.py',122),
  ('type -> TOKEN_INT','type',1,'p_type','yacc.py',132),
  ('type -> TOKEN_FLOAT','type',1,'p_type','yacc.py',133),
  ('body -> TOKEN_LBRACE dec_statements TOKEN_RBRACE','body',3,'p_body','yacc.py',143),
  ('dec_statements -> statement dec_statements','dec_statements',2,'p_dec_statements','yacc.py',148),
  ('dec_statements -> empty','dec_statements',1,'p_dec_statements','yacc.py',149),
  ('statement -> assign','statement',1,'p_statement','yacc.py',159),
  ('statement -> condition','statement',1,'p_statement','yacc.py',160),
  ('statement -> cycle','statement',1,'p_statement','yacc.py',161),
  ('statement -> f_call','statement',1,'p_statement','yacc.py',162),
  ('statement -> print','statement',1,'p_statement','yacc.py',163),
  ('print -> TOKEN_PRINT TOKEN_LPAREN expresiones TOKEN_RPAREN TOKEN_SEMICOLON','print',5,'p_print','yacc.py',168),
  ('expresiones -> TOKEN_CTE_STRING comas','expresiones',2,'p_expresiones','yacc.py',181),
  ('expresiones -> expresion comas','expresiones',2,'p_expresiones','yacc.py',182),
  ('comas -> TOKEN_COMMA expresion comas','comas',3,'p_comas','yacc.py',191),
  ('comas -> TOKEN_COMMA TOKEN_CTE_STRING comas','comas',3,'p_comas','yacc.py',192),
  ('comas -> empty','comas',1,'p_comas','yacc.py',193),
  ('saveQuad -> empty','saveQuad',1,'p_saveQuad','yacc.py',203),
  ('GotoF -> empty','GotoF',1,'p_GotoF','yacc.py',208),
  ('cycle -> TOKEN_WHILE TOKEN_LPAREN saveQuad expresion GotoF TOKEN_RPAREN TOKEN_DO body TOKEN_SEMICOLON','cycle',9,'p_cycle','yacc.py',215),
  ('saveQuadIF -> empty','saveQuadIF',1,'p_saveQuadIF','yacc.py',232),
  ('GotoFIF -> empty','GotoFIF',1,'p_GotoFIF','yacc.py',239),
  ('condition -> TOKEN_IF TOKEN_LPAREN expresion saveQuadIF TOKEN_RPAREN body GotoFIF else TOKEN_SEMICOLON','condition',9,'p_condition','yacc.py',247),
  ('else -> TOKEN_ELSE body','else',2,'p_else','yacc.py',261),
  ('else -> empty','else',1,'p_else','yacc.py',262),
  ('cte -> TOKEN_CTE_INT','cte',1,'p_cte','yacc.py',271),
  ('cte -> TOKEN_CTE_FLOAT','cte',1,'p_cte','yacc.py',272),
  ('expresion -> exp comparar','expresion',2,'p_expresion','yacc.py',281),
  ('comparar -> signo exp','comparar',2,'p_comparar','yacc.py',308),
  ('comparar -> empty','comparar',1,'p_comparar','yacc.py',309),
  ('signo -> TOKEN_GT','signo',1,'p_signo','yacc.py',316),
  ('signo -> TOKEN_LT','signo',1,'p_signo','yacc.py',317),
  ('signo -> TOKEN_NE','signo',1,'p_signo','yacc.py',318),
  ('exp -> termino exp_tail','exp',2,'p_exp','yacc.py',323),
  ('operacion_sum_res -> TOKEN_PLUS','operacion_sum_res',1,'p_operacion_sum_res','yacc.py',363),
  ('operacion_sum_res -> TOKEN_MINUS','operacion_sum_res',1,'p_operacion_sum_res','yacc.py',364),
  ('exp_tail -> operacion_sum_res termino exp_tail','exp_tail',3,'p_exp_tail','yacc.py',368),
  ('exp_tail -> empty','exp_tail',1,'p_exp_tail','yacc.py',369),
  ('termino -> factor termino_tail','termino',2,'p_termino','yacc.py',379),
  ('termino_tail -> operacion_mul_div factor termino_tail','termino_tail',3,'p_termino_tail','yacc.py',409),
  ('termino_tail -> empty','termino_tail',1,'p_termino_tail','yacc.py',410),
  ('operacion_mul_div -> TOKEN_DIV','operacion_mul_div',1,'p_operacion_mul_div','yacc.py',420),
  ('operacion_mul_div -> TOKEN_MULT','operacion_mul_div',1,'p_operacion_mul_div','yacc.py',421),
  ('factor -> definicion','factor',1,'p_factor','yacc.py',425),
  ('factor -> operaciones','factor',1,'p_factor','yacc.py',426),
  ('definicion -> TOKEN_LPAREN expresion TOKEN_RPAREN','definicion',3,'p_definicion','yacc.py',431),
  ('operaciones -> opciones_mas_menos id_cte','operaciones',2,'p_operaciones','yacc.py',438),
  ('opciones_mas_menos -> TOKEN_PLUS','opciones_mas_menos',1,'p_opciones_mas_menos','yacc.py',456),
  ('opciones_mas_menos -> TOKEN_MINUS','opciones_mas_menos',1,'p_opciones_mas_menos','yacc.py',457),
  ('opciones_mas_menos -> empty','opciones_mas_menos',1,'p_opciones_mas_menos','yacc.py',458),
  ('id_cte -> TOKEN_ID','id_cte',1,'p_id_cte','yacc.py',462),
  ('id_cte -> cte','id_cte',1,'p_id_cte','yacc.py',463),
  ('funcs -> TOKEN_VOID TOKEN_ID save_func_start TOKEN_LPAREN tipo TOKEN_RPAREN TOKEN_LCOL var body TOKEN_RCOL end_func TOKEN_SEMICOLON','funcs',12,'p_funcs','yacc.py',480),
  ('save_func_start -> empty','save_func_start',1,'p_save_func_start','yacc.py',489),
  ('end_func -> empty','end_func',1,'p_end_func','yacc.py',497),
  ('tipo -> def_tipo','tipo',1,'p_tipo','yacc.py',504),
  ('tipo -> empty','tipo',1,'p_tipo','yacc.py',505),
  ('def_tipo -> TOKEN_ID TOKEN_COLON type coma','def_tipo',4,'p_def_tipo','yacc.py',520),
  ('coma -> TOKEN_COMMA TOKEN_ID TOKEN_COLON type coma','coma',5,'p_coma','yacc.py',527),
  ('coma -> empty','coma',1,'p_coma','yacc.py',528),
  ('var -> vars','var',1,'p_var','yacc.py',539),
  ('var -> empty','var',1,'p_var','yacc.py',540),
  ('f_call -> TOKEN_ID era_quad TOKEN_LPAREN def_exp TOKEN_RPAREN gosub_quad TOKEN_SEMICOLON','f_call',7,'p_f_call','yacc.py',544),
  ('era_quad -> empty','era_quad',1,'p_era_quad','yacc.py',565),
  ('gosub_quad -> empty','gosub_quad',1,'p_gosub_quad','yacc.py',573),
  ('def_exp -> expresion param_quad coma2','def_exp',3,'p_def_exp','yacc.py',580),
  ('def_exp -> empty','def_exp',1,'p_def_exp','yacc.py',581),
  ('param_quad -> empty','param_quad',1,'p_param_quad','yacc.py',592),
  ('coma2 -> TOKEN_COMMA expresion param_quad_coma coma2','coma2',4,'p_coma2','yacc.py',602),
  ('coma2 -> empty','coma2',1,'p_coma2','yacc.py',603),
  ('param_quad_coma -> empty','param_quad_coma',1,'p_param_quad_coma','yacc.py',610),
  ('assign -> TOKEN_ID TOKEN_ASSIGN expresion TOKEN_SEMICOLON','assign',4,'p_assign','yacc.py',620),
