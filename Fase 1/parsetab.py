...
_lr_productions = [
  ...
  ('programa -> TOKEN_PROGRAM TOKEN_ID TOKEN_SEMICOLON saveGo dec_var dec_funcs TOKEN_MAIN fillMain body TOKEN_END','programa',10,'p_programa','yacc.py',41),
  ('saveGo -> empty','saveGo',1,'p_saveGo','yacc.py',48),
  ('fillMain -> empty','fillMain',1,'p_fillMain','yacc.py',54),
  ('dec_var -> vars','dec_var',1,'p_dec_var','yacc.py',61),
  ('dec_var -> empty','dec_var',1,'p_dec_var','yacc.py',62),
  ('dec_funcs -> funcs dec_funcs','dec_funcs',2,'p_dec_funcs','yacc.py',66),
  ('dec_funcs -> empty','dec_funcs',1,'p_dec_funcs','yacc.py',67),
  ('vars -> TOKEN_VAR variable rep_var','vars',3,'p_vars','yacc.py',77),
  ('rep_var -> variable rep_var','rep_var',2,'p_rep_var','yacc.py',85),
  ('rep_var -> empty','rep_var',1,'p_rep_var','yacc.py',86),
  ('variable -> TOKEN_ID mas_ids TOKEN_COLON type TOKEN_SEMICOLON','variable',5,'p_variable','yacc.py',96),
  ('mas_ids -> TOKEN_COMMA TOKEN_ID mas_ids','mas_ids',3,'p_mas_ids','yacc.py',106),
  ('mas_ids -> empty','mas_ids',1,'p_mas_ids','yacc.py',107),
  ('type -> TOKEN_INT','type',1,'p_type','yacc.py',117),
  ('type -> TOKEN_FLOAT','type',1,'p_type','yacc.py',118),
  ('body -> TOKEN_LBRACE dec_statements TOKEN_RBRACE','body',3,'p_body','yacc.py',127),
  ('dec_statements -> statement dec_statements','dec_statements',2,'p_dec_statements','yacc.py',131),
  ('dec_statements -> empty','dec_statements',1,'p_dec_statements','yacc.py',132),
  ('statement -> assign','statement',1,'p_statement','yacc.py',142),
  ('statement -> condition','statement',1,'p_statement','yacc.py',143),
  ('statement -> cycle','statement',1,'p_statement','yacc.py',144),
  ('statement -> f_call','statement',1,'p_statement','yacc.py',145),
  ('statement -> print','statement',1,'p_statement','yacc.py',146),
  ...
  ('comparar -> signo exp','comparar',2,'p_comparar','yacc.py',261),
  ('comparar -> empty','comparar',1,'p_comparar','yacc.py',262),
  ('signo -> TOKEN_GT','signo',1,'p_signo','yacc.py',269),
  ('signo -> TOKEN_LT','signo',1,'p_signo','yacc.py',270),
  ('signo -> TOKEN_NE','signo',1,'p_signo','yacc.py',271),
  ('exp -> termino suma_resta','exp',2,'p_exp','yacc.py',275),
  ('operacion_sum_res -> TOKEN_PLUS','operacion_sum_res',1,'p_operacion_sum_res','yacc.py',310),
  ('operacion_sum_res -> TOKEN_MINUS','operacion_sum_res',1,'p_operacion_sum_res','yacc.py',311),
  ('suma_resta -> operacion_sum_res termino suma_resta','suma_resta',3,'p_suma_resta','yacc.py',315),
  ('suma_resta -> empty','suma_resta',1,'p_suma_resta','yacc.py',316),
  ('termino -> factor multi_div','termino',2,'p_termino','yacc.py',326),
  ...
  ('funcs -> TOKEN_VOID TOKEN_ID save_func_start TOKEN_LPAREN tipo TOKEN_RPAREN TOKEN_LCOL var body TOKEN_RCOL end_func TOKEN_SEMICOLON','funcs',12,'p_funcs','yacc.py',425),
  ('save_func_start -> empty','save_func_start',1,'p_save_func_start','yacc.py',431),
  ('end_func -> empty','end_func',1,'p_end_func','yacc.py',438),
  ('tipo -> def_tipo','tipo',1,'p_tipo','yacc.py',444),
  ('tipo -> empty','tipo',1,'p_tipo','yacc.py',445),
  ('def_tipo -> TOKEN_ID TOKEN_COLON type coma','def_tipo',4,'p_def_tipo','yacc.py',458),
  ('coma -> TOKEN_COMMA TOKEN_ID TOKEN_COLON type coma','coma',5,'p_coma','yacc.py',465),
  ('coma -> empty','coma',1,'p_coma','yacc.py',466),
  ('var -> vars','var',1,'p_var','yacc.py',477),
  ('var -> empty','var',1,'p_var','yacc.py',478),
  ('f_call -> TOKEN_ID era_quad TOKEN_LPAREN def_exp TOKEN_RPAREN gosub_quad TOKEN_SEMICOLON','f_call',7,'p_f_call','yacc.py',482),
  ('era_quad -> empty','era_quad',1,'p_era_quad','yacc.py',499),
  ('gosub_quad -> empty','gosub_quad',1,'p_gosub_quad','yacc.py',506),
  ('def_exp -> expresion param_quad coma2','def_exp',3,'p_def_exp','yacc.py',512),
  ('def_exp -> empty','def_exp',1,'p_def_exp','yacc.py',513),
  ('param_quad -> empty','param_quad',1,'p_param_quad','yacc.py',523),
  ('coma2 -> TOKEN_COMMA expresion param_quad_coma coma2','coma2',4,'p_coma2','yacc.py',532),
  ('coma2 -> empty','coma2',1,'p_coma2','yacc.py',533),
  ('param_quad_coma -> empty','param_quad_coma',1,'p_param_quad_coma','yacc.py',540),
  ('assign -> TOKEN_ID TOKEN_ASSIGN expresion TOKEN_SEMICOLON','assign',4,'p_assign','yacc.py',549),
  ('empty -> <empty>','empty',0,'p_empty','yacc.py',558),
]
