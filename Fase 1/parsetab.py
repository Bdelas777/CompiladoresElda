...
_lr_productions = [
  ...
  ('operacion_sum_res -> TOKEN_PLUS','operacion_sum_res',1,'p_operacion_sum_res','yacc.py',281),
  ('operacion_sum_res -> TOKEN_MINUS','operacion_sum_res',1,'p_operacion_sum_res','yacc.py',282),
  ('exp_tail -> operacion_sum_res termino exp_tail','exp_tail',3,'p_exp_tail','yacc.py',287),
  ('exp_tail -> empty','exp_tail',1,'p_exp_tail','yacc.py',288),
  ('termino -> factor termino_tail','termino',2,'p_termino','yacc.py',300),
  ('termino_tail -> operacion_mul_div factor termino_tail','termino_tail',3,'p_termino_tail','yacc.py',324),
  ('termino_tail -> empty','termino_tail',1,'p_termino_tail','yacc.py',325),
  ...
  ('operaciones -> opciones_mas_menos id_cte','operaciones',2,'p_operaciones','yacc.py',351),
  ('opciones_mas_menos -> TOKEN_PLUS','opciones_mas_menos',1,'p_opciones_mas_menos','yacc.py',368),
  ('opciones_mas_menos -> TOKEN_MINUS','opciones_mas_menos',1,'p_opciones_mas_menos','yacc.py',369),
  ('opciones_mas_menos -> empty','opciones_mas_menos',1,'p_opciones_mas_menos','yacc.py',370),
  ('id_cte -> TOKEN_ID','id_cte',1,'p_id_cte','yacc.py',374),
  ('id_cte -> cte','id_cte',1,'p_id_cte','yacc.py',375),
  ('funcs -> TOKEN_VOID TOKEN_ID save_func_start TOKEN_LPAREN tipo TOKEN_RPAREN TOKEN_LCOL var body TOKEN_RCOL end_func TOKEN_SEMICOLON','funcs',12,'p_funcs','yacc.py',390),
  ('save_func_start -> empty','save_func_start',1,'p_save_func_start','yacc.py',396),
  ('end_func -> empty','end_func',1,'p_end_func','yacc.py',403),
  ('tipo -> def_tipo','tipo',1,'p_tipo','yacc.py',409),
  ('tipo -> empty','tipo',1,'p_tipo','yacc.py',410),
  ('def_tipo -> TOKEN_ID TOKEN_COLON type coma','def_tipo',4,'p_def_tipo','yacc.py',423),
  ('coma -> TOKEN_COMMA TOKEN_ID TOKEN_COLON type coma','coma',5,'p_coma','yacc.py',430),
  ('coma -> empty','coma',1,'p_coma','yacc.py',431),
  ('var -> vars','var',1,'p_var','yacc.py',442),
  ('var -> empty','var',1,'p_var','yacc.py',443),
  ('f_call -> TOKEN_ID era_quad TOKEN_LPAREN def_exp TOKEN_RPAREN gosub_quad TOKEN_SEMICOLON','f_call',7,'p_f_call','yacc.py',447),
  ('era_quad -> empty','era_quad',1,'p_era_quad','yacc.py',464),
  ('gosub_quad -> empty','gosub_quad',1,'p_gosub_quad','yacc.py',471),
  ('def_exp -> expresion param_quad coma2','def_exp',3,'p_def_exp','yacc.py',477),
  ('def_exp -> empty','def_exp',1,'p_def_exp','yacc.py',478),
  ('param_quad -> empty','param_quad',1,'p_param_quad','yacc.py',488),
  ('coma2 -> TOKEN_COMMA expresion param_quad_coma coma2','coma2',4,'p_coma2','yacc.py',497),
  ('coma2 -> empty','coma2',1,'p_coma2','yacc.py',498),
  ('param_quad_coma -> empty','param_quad_coma',1,'p_param_quad_coma','yacc.py',505),
  ('assign -> TOKEN_ID TOKEN_ASSIGN expresion TOKEN_SEMICOLON','assign',4,'p_assign','yacc.py',514),
  ('empty -> <empty>','empty',0,'p_empty','yacc.py',523),
]
