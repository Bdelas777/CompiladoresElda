...
_lr_productions = [
  ...
  ('saveGo -> empty','saveGo',1,'p_saveGo','yacc.py',31),
  ('fillMain -> empty','fillMain',1,'p_fillMain','yacc.py',37),
  ('dec_var -> vars','dec_var',1,'p_dec_var','yacc.py',44),
  ('dec_var -> empty','dec_var',1,'p_dec_var','yacc.py',45),
  ('dec_funcs -> funcs dec_funcs','dec_funcs',2,'p_dec_funcs','yacc.py',49),
  ('dec_funcs -> empty','dec_funcs',1,'p_dec_funcs','yacc.py',50),
  ('vars -> TOKEN_VAR variable rep_var','vars',3,'p_vars','yacc.py',60),
  ('rep_var -> variable rep_var','rep_var',2,'p_rep_var','yacc.py',68),
  ('rep_var -> empty','rep_var',1,'p_rep_var','yacc.py',69),
  ('variable -> TOKEN_ID mas_ids TOKEN_COLON type TOKEN_SEMICOLON','variable',5,'p_variable','yacc.py',79),
  ('mas_ids -> TOKEN_COMMA TOKEN_ID mas_ids','mas_ids',3,'p_mas_ids','yacc.py',89),
  ('mas_ids -> empty','mas_ids',1,'p_mas_ids','yacc.py',90),
  ('type -> TOKEN_INT','type',1,'p_type','yacc.py',100),
  ('type -> TOKEN_FLOAT','type',1,'p_type','yacc.py',101),
  ('body -> TOKEN_LBRACE dec_statements TOKEN_RBRACE','body',3,'p_body','yacc.py',110),
  ('dec_statements -> statement dec_statements','dec_statements',2,'p_dec_statements','yacc.py',114),
  ('dec_statements -> empty','dec_statements',1,'p_dec_statements','yacc.py',115),
  ('statement -> assign','statement',1,'p_statement','yacc.py',125),
  ('statement -> condition','statement',1,'p_statement','yacc.py',126),
  ('statement -> cycle','statement',1,'p_statement','yacc.py',127),
  ('statement -> f_call','statement',1,'p_statement','yacc.py',128),
  ('statement -> print','statement',1,'p_statement','yacc.py',129),
  ('print -> TOKEN_PRINT TOKEN_LPAREN expresiones TOKEN_RPAREN TOKEN_SEMICOLON','print',5,'p_print','yacc.py',133),
  ('expresiones -> TOKEN_CTE_STRING comas','expresiones',2,'p_expresiones','yacc.py',144),
  ('expresiones -> expresion comas','expresiones',2,'p_expresiones','yacc.py',145),
  ('comas -> TOKEN_COMMA expresion comas','comas',3,'p_comas','yacc.py',152),
  ('comas -> TOKEN_COMMA TOKEN_CTE_STRING comas','comas',3,'p_comas','yacc.py',153),
  ('comas -> empty','comas',1,'p_comas','yacc.py',154),
  ('saveQuad -> empty','saveQuad',1,'p_saveQuad','yacc.py',164),
  ('GotoF -> empty','GotoF',1,'p_GotoF','yacc.py',168),
  ('cycle -> TOKEN_WHILE TOKEN_LPAREN saveQuad expresion GotoF TOKEN_RPAREN TOKEN_DO body TOKEN_SEMICOLON','cycle',9,'p_cycle','yacc.py',174),
  ('saveQuadIF -> empty','saveQuadIF',1,'p_saveQuadIF','yacc.py',184),
  ('GotoFIF -> empty','GotoFIF',1,'p_GotoFIF','yacc.py',190),
  ('condition -> TOKEN_IF TOKEN_LPAREN expresion saveQuadIF TOKEN_RPAREN body GotoFIF else TOKEN_SEMICOLON','condition',9,'p_condition','yacc.py',197),
  ('else -> TOKEN_ELSE body','else',2,'p_else','yacc.py',207),
  ('else -> empty','else',1,'p_else','yacc.py',208),
  ('cte -> TOKEN_CTE_INT','cte',1,'p_cte','yacc.py',215),
  ('cte -> TOKEN_CTE_FLOAT','cte',1,'p_cte','yacc.py',216),
  ('expresion -> exp comparar','expresion',2,'p_expresion','yacc.py',223),
  ('comparar -> signo exp','comparar',2,'p_comparar','yacc.py',242),
  ('comparar -> empty','comparar',1,'p_comparar','yacc.py',243),
  ('signo -> TOKEN_GT','signo',1,'p_signo','yacc.py',250),
  ('signo -> TOKEN_LT','signo',1,'p_signo','yacc.py',251),
  ('signo -> TOKEN_NE','signo',1,'p_signo','yacc.py',252),
  ('exp -> termino exp_tail','exp',2,'p_exp','yacc.py',257),
  ('exp_tail -> TOKEN_PLUS termino exp_tail','exp_tail',3,'p_exp_tail','yacc.py',282),
  ('exp_tail -> TOKEN_MINUS termino exp_tail','exp_tail',3,'p_exp_tail','yacc.py',283),
  ('exp_tail -> empty','exp_tail',1,'p_exp_tail','yacc.py',284),
  ('termino -> factor termino_tail','termino',2,'p_termino','yacc.py',295),
  ('termino_tail -> operacion_mul_div factor termino_tail','termino_tail',3,'p_termino_tail','yacc.py',319),
  ('termino_tail -> empty','termino_tail',1,'p_termino_tail','yacc.py',320),
  ('operacion_mul_div -> TOKEN_DIV','operacion_mul_div',1,'p_operacion_mul_div','yacc.py',330),
  ('operacion_mul_div -> TOKEN_MULT','operacion_mul_div',1,'p_operacion_mul_div','yacc.py',331),
  ('factor -> definicion','factor',1,'p_factor','yacc.py',335),
  ('factor -> operaciones','factor',1,'p_factor','yacc.py',336),
  ('definicion -> TOKEN_LPAREN expresion TOKEN_RPAREN','definicion',3,'p_definicion','yacc.py',340),
  ('operaciones -> opciones_mas_menos id_cte','operaciones',2,'p_operaciones','yacc.py',346),
  ('opciones_mas_menos -> TOKEN_PLUS','opciones_mas_menos',1,'p_opciones_mas_menos','yacc.py',363),
  ('opciones_mas_menos -> TOKEN_MINUS','opciones_mas_menos',1,'p_opciones_mas_menos','yacc.py',364),
  ('opciones_mas_menos -> empty','opciones_mas_menos',1,'p_opciones_mas_menos','yacc.py',365),
  ('id_cte -> TOKEN_ID','id_cte',1,'p_id_cte','yacc.py',369),
  ('id_cte -> cte','id_cte',1,'p_id_cte','yacc.py',370),
  ('funcs -> TOKEN_VOID TOKEN_ID save_func_start TOKEN_LPAREN tipo TOKEN_RPAREN TOKEN_LCOL var body TOKEN_RCOL end_func TOKEN_SEMICOLON','funcs',12,'p_funcs','yacc.py',385),
  ('save_func_start -> empty','save_func_start',1,'p_save_func_start','yacc.py',391),
  ('end_func -> empty','end_func',1,'p_end_func','yacc.py',398),
  ('scopefun -> empty','scopefun',1,'p_scopefun','yacc.py',404),
  ('tipo -> def_tipo','tipo',1,'p_tipo','yacc.py',410),
  ('tipo -> empty','tipo',1,'p_tipo','yacc.py',411),
  ('def_tipo -> TOKEN_ID TOKEN_COLON type coma','def_tipo',4,'p_def_tipo','yacc.py',424),
  ('coma -> TOKEN_COMMA TOKEN_ID TOKEN_COLON type coma','coma',5,'p_coma','yacc.py',431),
  ('coma -> empty','coma',1,'p_coma','yacc.py',432),
  ('var -> vars','var',1,'p_var','yacc.py',443),
  ('var -> empty','var',1,'p_var','yacc.py',444),
  ('f_call -> TOKEN_ID era_quad TOKEN_LPAREN def_exp TOKEN_RPAREN gosub_quad TOKEN_SEMICOLON','f_call',7,'p_f_call','yacc.py',448),
  ('era_quad -> empty','era_quad',1,'p_era_quad','yacc.py',465),
  ('gosub_quad -> empty','gosub_quad',1,'p_gosub_quad','yacc.py',472),
  ('def_exp -> expresion param_quad coma2','def_exp',3,'p_def_exp','yacc.py',478),
  ('def_exp -> empty','def_exp',1,'p_def_exp','yacc.py',479),
  ('param_quad -> empty','param_quad',1,'p_param_quad','yacc.py',489),
  ('coma2 -> TOKEN_COMMA expresion param_quad_coma coma2','coma2',4,'p_coma2','yacc.py',498),
  ('coma2 -> empty','coma2',1,'p_coma2','yacc.py',499),
  ('param_quad_coma -> empty','param_quad_coma',1,'p_param_quad_coma','yacc.py',506),
  ('assign -> TOKEN_ID TOKEN_ASSIGN expresion TOKEN_SEMICOLON','assign',4,'p_assign','yacc.py',515),
  ('empty -> <empty>','empty',0,'p_empty','yacc.py',524),
]
