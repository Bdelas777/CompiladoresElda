...
_lr_productions = [
  ...
  ('programa -> TOKEN_PROGRAM TOKEN_ID TOKEN_SEMICOLON saveGo dec_var dec_funcs TOKEN_MAIN fillMain body TOKEN_END','programa',10,'p_programa','yacc.py',22),
  ('saveGo -> empty','saveGo',1,'p_saveGo','yacc.py',29),
  ('fillMain -> empty','fillMain',1,'p_fillMain','yacc.py',35),
