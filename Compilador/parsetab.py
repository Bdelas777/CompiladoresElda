...
_lr_productions = [
  ...
  ('saveGo -> empty','saveGo',1,'p_saveGo','yacc.py',46),
  ('fillMain -> empty','fillMain',1,'p_fillMain','yacc.py',52),
  ('dec_var -> vars','dec_var',1,'p_dec_var','yacc.py',63),
  ('dec_var -> empty','dec_var',1,'p_dec_var','yacc.py',64),
  ('dec_funcs -> funcs dec_funcs','dec_funcs',2,'p_dec_funcs','yacc.py',68),
  ('dec_funcs -> empty','dec_funcs',1,'p_dec_funcs','yacc.py',69),
  ('vars -> TOKEN_VAR variable rep_var','vars',3,'p_vars','yacc.py',79),
  ('rep_var -> variable rep_var','rep_var',2,'p_rep_var','yacc.py',87),
  ('rep_var -> empty','rep_var',1,'p_rep_var','yacc.py',88),
  ('variable -> TOKEN_ID mas_ids TOKEN_COLON type TOKEN_SEMICOLON','variable',5,'p_variable','yacc.py',98),
  ('mas_ids -> TOKEN_COMMA TOKEN_ID mas_ids','mas_ids',3,'p_mas_ids','yacc.py',108),
  ('mas_ids -> empty','mas_ids',1,'p_mas_ids','yacc.py',109),
  ('type_fun -> TOKEN_INT','type_fun',1,'p_type_fun','yacc.py',119),
  ('type_fun -> TOKEN_FLOAT','type_fun',1,'p_type_fun','yacc.py',120),
  ('type_fun -> TOKEN_VOID','type_fun',1,'p_type_fun','yacc.py',121),
  ('type -> TOKEN_INT','type',1,'p_type','yacc.py',130),
  ('type -> TOKEN_FLOAT','type',1,'p_type','yacc.py',131),
  ('body -> TOKEN_LBRACE dec_statements TOKEN_RBRACE','body',3,'p_body','yacc.py',140),
  ('dec_statements -> statement dec_statements','dec_statements',2,'p_dec_statements','yacc.py',144),
  ('dec_statements -> empty','dec_statements',1,'p_dec_statements','yacc.py',145),
  ('statement -> assign','statement',1,'p_statement','yacc.py',155),
  ('statement -> condition','statement',1,'p_statement','yacc.py',156),
  ('statement -> cycle','statement',1,'p_statement','yacc.py',157),
  ('statement -> f_call','statement',1,'p_statement','yacc.py',158),
  ('statement -> print','statement',1,'p_statement','yacc.py',159),
  ('statement -> for_cycle','statement',1,'p_statement','yacc.py',160),
  ('statement -> return_stmt','statement',1,'p_statement','yacc.py',161),
  ('return_stmt -> TOKEN_RETURN expresion TOKEN_SEMICOLON','return_stmt',3,'p_return_stmt','yacc.py',165),
  ('print -> TOKEN_PRINT TOKEN_LPAREN expresiones TOKEN_RPAREN TOKEN_SEMICOLON','print',5,'p_print','yacc.py',176),
  ('expresiones -> TOKEN_CTE_STRING comas','expresiones',2,'p_expresiones','yacc.py',187),
  ('expresiones -> expresion comas','expresiones',2,'p_expresiones','yacc.py',188),
  ('comas -> TOKEN_COMMA expresion comas','comas',3,'p_comas','yacc.py',195),
  ('comas -> TOKEN_COMMA TOKEN_CTE_STRING comas','comas',3,'p_comas','yacc.py',196),
  ('comas -> empty','comas',1,'p_comas','yacc.py',197),
  ('saveQuad -> empty','saveQuad',1,'p_saveQuad','yacc.py',207),
  ('GotoF -> empty','GotoF',1,'p_GotoF','yacc.py',211),
  ('cycle -> TOKEN_WHILE TOKEN_LPAREN saveQuad expresion GotoF TOKEN_RPAREN TOKEN_DO body TOKEN_SEMICOLON','cycle',9,'p_cycle','yacc.py',217),
  ('saveQuadIF -> empty','saveQuadIF',1,'p_saveQuadIF','yacc.py',227),
  ('GotoFIF -> empty','GotoFIF',1,'p_GotoFIF','yacc.py',233),
  ('condition -> TOKEN_IF TOKEN_LPAREN expresion saveQuadIF TOKEN_RPAREN body GotoFIF else TOKEN_SEMICOLON','condition',9,'p_condition','yacc.py',240),
  ('else -> TOKEN_ELSE body','else',2,'p_else','yacc.py',249),
  ('else -> empty','else',1,'p_else','yacc.py',250),
  ('cte -> TOKEN_CTE_INT','cte',1,'p_cte','yacc.py',257),
  ('cte -> TOKEN_CTE_FLOAT','cte',1,'p_cte','yacc.py',258),
  ('expresion -> exp comparar','expresion',2,'p_expresion','yacc.py',265),
  ('comparar -> signo exp','comparar',2,'p_comparar','yacc.py',283),
  ('comparar -> empty','comparar',1,'p_comparar','yacc.py',284),
  ('signo -> TOKEN_GT','signo',1,'p_signo','yacc.py',291),
  ('signo -> TOKEN_LT','signo',1,'p_signo','yacc.py',292),
  ('signo -> TOKEN_NE','signo',1,'p_signo','yacc.py',293),
  ('exp -> termino suma_resta','exp',2,'p_exp','yacc.py',297),
  ('operacion_sum_res -> TOKEN_PLUS','operacion_sum_res',1,'p_operacion_sum_res','yacc.py',320),
  ('operacion_sum_res -> TOKEN_MINUS','operacion_sum_res',1,'p_operacion_sum_res','yacc.py',321),
  ('suma_resta -> operacion_sum_res termino suma_resta','suma_resta',3,'p_suma_resta','yacc.py',325),
  ('suma_resta -> empty','suma_resta',1,'p_suma_resta','yacc.py',326),
  ('termino -> factor multi_div','termino',2,'p_termino','yacc.py',336),
  ('multi_div -> operacion_mul_div factor multi_div','multi_div',3,'p_multi_div','yacc.py',359),
  ('multi_div -> empty','multi_div',1,'p_multi_div','yacc.py',360),
  ('operacion_mul_div -> TOKEN_DIV','operacion_mul_div',1,'p_operacion_mul_div','yacc.py',370),
  ('operacion_mul_div -> TOKEN_MULT','operacion_mul_div',1,'p_operacion_mul_div','yacc.py',371),
  ('factor -> definicion','factor',1,'p_factor','yacc.py',375),
  ('factor -> operaciones','factor',1,'p_factor','yacc.py',376),
  ('definicion -> TOKEN_LPAREN expresion TOKEN_RPAREN','definicion',3,'p_definicion','yacc.py',380),
  ('operaciones -> opciones_mas_menos id_cte','operaciones',2,'p_operaciones','yacc.py',386),
  ('opciones_mas_menos -> TOKEN_PLUS','opciones_mas_menos',1,'p_opciones_mas_menos','yacc.py',403),
  ('opciones_mas_menos -> TOKEN_MINUS','opciones_mas_menos',1,'p_opciones_mas_menos','yacc.py',404),
  ('opciones_mas_menos -> empty','opciones_mas_menos',1,'p_opciones_mas_menos','yacc.py',405),
  ('id_cte -> TOKEN_ID','id_cte',1,'p_id_cte','yacc.py',409),
  ('id_cte -> cte','id_cte',1,'p_id_cte','yacc.py',410),
  ('id_cte -> function_call_expr','id_cte',1,'p_id_cte','yacc.py',411),
  ('funcs -> type_fun TOKEN_ID save_func_start TOKEN_LPAREN tipo TOKEN_RPAREN TOKEN_LCOL var body TOKEN_RCOL end_func TOKEN_SEMICOLON','funcs',12,'p_funcs','yacc.py',428),
  ('save_func_start -> empty','save_func_start',1,'p_save_func_start','yacc.py',434),
  ('end_func -> empty','end_func',1,'p_end_func','yacc.py',449),
  ('tipo -> def_tipo','tipo',1,'p_tipo','yacc.py',455),
  ('tipo -> empty','tipo',1,'p_tipo','yacc.py',456),
  ('def_tipo -> TOKEN_ID TOKEN_COLON type coma','def_tipo',4,'p_def_tipo','yacc.py',469),
  ('coma -> TOKEN_COMMA TOKEN_ID TOKEN_COLON type coma','coma',5,'p_coma','yacc.py',476),
  ('coma -> empty','coma',1,'p_coma','yacc.py',477),
  ('var -> vars','var',1,'p_var','yacc.py',488),
  ('var -> empty','var',1,'p_var','yacc.py',489),
  ('f_call -> TOKEN_ID era_quad TOKEN_LPAREN def_exp TOKEN_RPAREN gosub_quad TOKEN_SEMICOLON','f_call',7,'p_f_call','yacc.py',493),
  ('function_call_expr -> TOKEN_ID era_quad TOKEN_LPAREN def_exp TOKEN_RPAREN gosub_quad','function_call_expr',6,'p_function_call_expr','yacc.py',510),
  ('era_quad -> empty','era_quad',1,'p_era_quad','yacc.py',528),
  ('gosub_quad -> empty','gosub_quad',1,'p_gosub_quad','yacc.py',535),
  ('def_exp -> expresion param_quad coma2','def_exp',3,'p_def_exp','yacc.py',541),
  ('def_exp -> empty','def_exp',1,'p_def_exp','yacc.py',542),
  ('param_quad -> empty','param_quad',1,'p_param_quad','yacc.py',552),
  ('coma2 -> TOKEN_COMMA expresion param_quad_coma coma2','coma2',4,'p_coma2','yacc.py',561),
  ('coma2 -> empty','coma2',1,'p_coma2','yacc.py',562),
  ('param_quad_coma -> empty','param_quad_coma',1,'p_param_quad_coma','yacc.py',569),
  ('assign -> TOKEN_ID TOKEN_ASSIGN expresion TOKEN_SEMICOLON','assign',4,'p_assign','yacc.py',578),
  ('for_cycle -> TOKEN_FOR TOKEN_LPAREN for_init TOKEN_SEMICOLON saveQuadFor expresion GotoFFor TOKEN_SEMICOLON for_increment TOKEN_RPAREN TOKEN_DO body TOKEN_SEMICOLON','for_cycle',13,'p_for_cycle','yacc.py',587),
  ('for_init -> assign_for','for_init',1,'p_for_init','yacc.py',604),
  ('for_init -> empty','for_init',1,'p_for_init','yacc.py',605),
  ('assign_for -> TOKEN_ID TOKEN_ASSIGN expresion','assign_for',3,'p_assign_for','yacc.py',609),
  ('for_increment -> assign_for','for_increment',1,'p_for_increment','yacc.py',618),
  ('for_increment -> empty','for_increment',1,'p_for_increment','yacc.py',619),
  ('saveQuadFor -> empty','saveQuadFor',1,'p_saveQuadFor','yacc.py',623),
  ('GotoFFor -> empty','GotoFFor',1,'p_GotoFFor','yacc.py',627),
  ('empty -> <empty>','empty',0,'p_empty','yacc.py',633),
]
